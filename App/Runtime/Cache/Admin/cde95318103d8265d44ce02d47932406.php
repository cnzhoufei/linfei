                        ...
                        <input type="hidden" name="id" value="<?php echo ($config['id']); ?>" />
                         <input type="hidden" name="logo" value="<?php echo ($config[logo]); ?>" />
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">公司名称<span style="color:#f00;">*</span></label>
                                <div class="col-sm-9"><input class="col-sm-12" type="text" name="name" value="<?php echo ($config['name']); ?>"></div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">公司英文名称<span style="color:#f00;">*</span></label>
                                <div class="col-sm-9"><input class="col-sm-12" type="text" name="company" value="<?php echo ($config['company']); ?>"></div>
                            </div>
