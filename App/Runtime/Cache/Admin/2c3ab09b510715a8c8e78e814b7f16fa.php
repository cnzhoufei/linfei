                            ...
                            <div class="row">
                                <div class='col-sm-2'>
                                    <select class="form-control" name='code'>
                                        ...
                                        <?php if(is_array($adPosition)): $i = 0; $__LIST__ = $adPosition;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><option value="{$key}">{$data}</option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                    <script>
                            ...
                            <form action="{:U('admin/adList',array('op'=>'order'))}" method="post">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody>
                                                <?php if($ad){ ?>
                                                <?php if(is_array($ad)): $i = 0; $__LIST__ = $ad;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr class="pointer even" title="">
                                                        <td><input type="text" name="order_<?php echo ($data['sorting']); ?>" value="<?php echo ($data['sorting']); ?>" style="width:30px;padding:0 5px;margin:0"/></td>
