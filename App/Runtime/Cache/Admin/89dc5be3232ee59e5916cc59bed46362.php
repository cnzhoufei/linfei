                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <input type="hidden" name="id" value="<?php echo ($article['id']); ?>" />
                         <input type="hidden" name="logo" value="<?php echo ($article['img']); ?>" />
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">文章名<span style="color:#f00;">*</span></label>
                                <div class="col-sm-9"><input class="col-sm-12" type="text" name="name" value="<?php echo ($article['name']); ?>"></div>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">文章标题<span style="color:#f00;">*</span></label>
                                <div class="col-sm-9"><input class="col-sm-12" type="text" name="title" value="<?php echo ($article['title']); ?>"></div>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">关键词<span style="color:#f00;">*</span></label>
                                <div class="col-sm-9"><input class="col-sm-12" type="text" name="keywords" value="<?php echo ($article['keywords']); ?>"></div>
                            </div>
                             <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">描述<span style="color:#f00;">*</span></label>
                                <div class="col-sm-9">
                                    <textarea class="col-sm-12" name='description'><?php echo stripslashes($article['description']);?></textarea>
                                </div>   
                            </div>
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <label>
                                        <input name="status" <?php if(empty($article['status'])){ }else{ ?>checked='checked'<?php } ?> class="ace ace-switch ace-switch-7" type="checkbox" value='1'>
                                        <span class="lbl"></span>
                                    </label>
                                </div>
                            </div>
                           ...
                           <style>#articleimg img,#imgss img{width:100px;height: 100px;}</style>
                            <div class="form-group" id="imgss">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"></label>
                                <div class="col-sm-9">
                                <span id="imgs"><img src='<?php echo ($article[img]); ?>' id="img" /></span>
                                </div>
                            </div>

                         
                            <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 文章类容 <span style="color:#f00;">*</span></label>

                                        <div class="col-sm-9">
                                                <script id="article" type="text" name="text" style="width:100%;height:500px;"><?php echo (htmlspecialchars_decode($article['text'])); ?></script>
                                        </div>
                            </div>
