                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="tabbable">
                            ...
                            <li <?php echo !($_GET['type'])?'class="active"':'' ?>>
                                    <a data-toggle="tab" href="javascript:;" onclick="location.href='<?php echo U('Classify/index');?>'">
                                        全部分类
                                    </a>
                                </li>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <?php if(is_array($classify)): $i = 0; $__LIST__ = $classify;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr class="pointer even" title="" id="delete_<?php echo ($data['id']); ?>">
                                                        <td>
                                                        <input type="text" value="<?php echo ($data['sorting']); ?>" style="width:50px;height:30px;padding:0 5px;margin:0" onchange="sorting('classify',this,<?php echo ($data['id']); ?>)" /></td>
                                                        <td class="center"><?php echo ($data['id']); ?></td>
                                                        <td class="center"><?php echo ($data['layer']); ?></td>
                                                        <td>
                                                        <?php echo ($data['name']); ?>
                                                        <a href="<?php echo U('Classify/index');?>?type=<?php echo ($arr[ $data['type' ]]); ?>&pid=<?php echo ($data['id']); ?>&layer=<?php echo ($data['layer']+1); ?>">
                                                        <?php if($data['pclass']){ ?>
                                                        ...
                                                        <td>
                                                            ...
                                                            |
                                                            <a href="ajaxscript:;" onclick="mydel('<?php echo ($data['id']); ?>','<?php echo U('classify/ajaxdelete');?>','delete_<?php echo ($data['id']); ?>')" title="删除">删除</a>
                                                        </td>
