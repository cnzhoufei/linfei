                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($product)): $i = 0; $__LIST__ = $product;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr class="pointer even" id="<?php echo ($data['id']); ?>" x='0' onclick="choose(this)">
                                            <td>
                                            <input type="text" value="<?php echo ($data['sorting']); ?>" style="width:50px;padding:0 5px;margin:0;border:none;" onchange="sorting('product',this,'<?php echo ($data['id']); ?>')" />
                                            </td>
                                            <td><?php echo ($data['id']); ?></td>
                                            <td><img src="<?php echo adminimg($data['id'],100,75,'product');?>"></td>
                                           ...
                                           <td>
                                            <a  v="<?php echo ($data['recommended']); ?>" href="javascript:;" onclick="status2('product', '<?php echo ($data[id]); ?>', 'recommended', this)">
                                           ...
                                           <td>
                                            <a  v="<?php echo ($data['new']); ?>" href="javascript:;" onclick="status2('product', '<?php echo ($data[id]); ?>', 'new', this)">
                                            <?php if(($data['new'])): ?><img src="/App/Admin/View/style/images/yes.png">
                                            <?php else: ?>
                                            <img src="/App/Admin/View/style/images/cancel.png"><?php endif; ?>
                                           </a></td>
                                           <td>
                                            <a  v="<?php echo ($data['selling']); ?>" href="javascript:;" onclick="status2('product', '<?php echo ($data[id]); ?>', 'selling', this)">
                                            <?php if(($data['selling'])): ?><img src="/App/Admin/View/style/images/yes.png">
                                            <?php else: ?>
                                            <img src="/App/Admin/View/style/images/cancel.png"><?php endif; ?>
                                           </a></td>
                                            <td>
                                            <a  v="<?php echo ($data['status']); ?>" href="javascript:;" onclick="status2('product', '<?php echo ($data[id]); ?>', 'status', this)">
                                            ...
                                            <td> 
                                                ...
                                                |
                                                <a id="" href="<?php echo U('Product/addproduct');?>?id=<?php echo ($data['id']); ?>&p=<?php echo ($_GET['p']); ?>" title="">编辑</a>
                                                |
