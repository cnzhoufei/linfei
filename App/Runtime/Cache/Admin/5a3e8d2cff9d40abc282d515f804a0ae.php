...
<style type="text/css">
.form-group li{list-style:none;float:left;width:50%;min-width:280px;font-size:25px;}
                    ...
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->                        
                            <div class="form-group" style="width:60%;margin:0 auto;">
                                <ul>
                                <?php if(is_array($back)): foreach($back as $kk=>$v): ?><li><i style="color:#FFE68E;" class="<?php echo ($v['icon']); ?>"></i>&nbsp;<a href="<?php echo U('sqllist');?>?name=<?php echo ($v['name']); ?>"><?php echo ($v['name']); ?></a></li><?php endforeach; endif; ?>    
                                </ul>
                            </div>                                                       
                        <!-- PAGE CONTENT ENDS -->
                    </div><!-- /.col -->
