                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr class="pointer even" id="<?php echo ($data['id']); ?>" x='0' onclick="choose(this)">
                                            <td>
                                            <input type="text" value="<?php echo ($data['sorting']); ?>" style="width:50px;padding:0 5px;margin:0;border:none;" onchange="sorting('<?php echo U('Article/ajaxsorting');?>',this,'<?php echo ($data['id']); ?>')" />
                                            </td>
                                            <td><?php echo ($data['id']); ?></td>
                                            <td><img src="<?php echo articleimgadmin($data['id'],100,75);?>"></td>
                                           ...
                                           <td>
                                            <a  v="<?php echo ($data['recommended']); ?>" href="javascript:;" onclick="status2('<?php echo U('article/status');?>', '<?php echo ($data[id]); ?>', 'recommended', this)">
                                           ...
                                           <td>
                                            <a  v="<?php echo ($data['recommendeds']); ?>" href="javascript:;" onclick="status2('<?php echo U('article/status');?>', '<?php echo ($data[id]); ?>', 'recommendeds', this)">
                                            <?php if(($data['recommendeds'])): ?><img src="/App/Admin/View/style/images/yes.png">
                                            <?php else: ?>
                                            <img src="/App/Admin/View/style/images/cancel.png"><?php endif; ?>
                                           </a></td>
                                           <td>
                                            <a  v="<?php echo ($data['headlines']); ?>" href="javascript:;" onclick="status2('<?php echo U('article/status');?>', '<?php echo ($data[id]); ?>', 'headlines', this)">
                                            <?php if(($data['headlines'])): ?><img src="/App/Admin/View/style/images/yes.png">
                                            <?php else: ?>
                                            <img src="/App/Admin/View/style/images/cancel.png"><?php endif; ?>
                                           </a></td>
                                            <td>
                                            <a  v="<?php echo ($data['status']); ?>" href="javascript:;" onclick="status2('<?php echo U('article/status');?>', '<?php echo ($data[id]); ?>', 'status', this)">
                                            ...
                                            <td> 
                                                ...
                                                |
                                                <a id="" onclick="mydelete('<?php echo ($data['id']); ?>','<?php echo U('Article/del');?>','<?php echo ($data['id']); ?>')" href="ajaxSrcipt:;" title="删除">删除</a> | 
                                            </td>
...
function states(v){
    ...
    $.post("<?php echo U('Article/states');?>",{'v':v, 'arr':arr} ,function(res){
...
function deletes(v){
 if(confirm('你确定删除吗？')){
    ...
    $.post("<?php echo U('Article/deletes');?>",{'v':v, 'arr':arr} ,function(res){
