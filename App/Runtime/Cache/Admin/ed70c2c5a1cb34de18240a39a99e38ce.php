                        ...
                        <div class="tabbable">
                         ...
                         <div class="tab-content">
                                <div id="home" class="tab-pane in active">
                                    <div class="row">
                                        <div class="col-xs-12">
                                           <div style="width:100px;float:right;line-height:30px;">
                                           <a href="<?php echo U('User/addgroup');?>">
                                           <i class=" icon-plus icon-on-right bigger-200"></i></a>
                                           </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                            <?php if($grouplist){ ?>
                                            <?php if(is_array($grouplist)): $i = 0; $__LIST__ = $grouplist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr class="pointer even" title="">
                                                    <td><?php echo ($data['id']); ?></td>
                                                    <td><?php echo ($data['name']); ?></td>
                                                    <td><?php echo date('Y-m-d',$data['time']);?></td>
                                                    <td>
                                        <?php if($data['id'] != 1){ ?>
                                        <a href="<?php echo U('User/addgroup');?>?id=<?php echo ($data['id']); ?>">编辑</a>
                                                        |
