                        ...
                        <!-- PAGE CONTENT BEGINS -->                        
                            ...
                            <input type="hidden" name="id" value="<?php echo ($pic['id']); ?>" />
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                                <input type="text" name="name" value="<?php echo ($pic['name']); ?>" class="col-sm-12" />
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="url" placeholder="例如：http://www.linfei.cc" value="<?php echo ($pic['url']); ?>" class="col-sm-12" />
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="sorting" value="<?php echo intval($pic['sorting']);?>" class="col-sm-12" />
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="remarks" placeholder="例如：说明" value="<?php echo ($pic['remarks']); ?>" class="col-sm-12" />
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                        <label>
                                            <input name="blank" class="ace ace-switch ace-switch-7" type="checkbox" <?php if(!$pic['blank']){ }else{ ?>checked='checked'<?php } ?> value='1'>
                                            <span class="lbl"></span>
                                        </label>
                                        </div>
                                </div>
                                 <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                        <label>
                                            <input name="status" class="ace ace-switch ace-switch-7" type="checkbox" <?php if(!$pic['status']){ }else{ ?>checked='checked'<?php } ?> value='1'>
                                            <span class="lbl"></span>
                                        </label>
                                        </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                <input  class="col-sm-12" type="button" value="上传图片" onClick="GetUploadify(1,'picimg','imgs')" style="width:150px;" />   
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <span id="imgs"><img src="<?php echo ($pic['img']); ?>"></span>
                            </div>
