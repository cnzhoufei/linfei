                    ...
                    <div class="col-sm-12">
                        <div class="tabbable">
                            <ul class="nav nav-tabs" id="myTab">
                                <li <?php echo $level==0?'class="active"':'' ?>>
                                <a data-toggle="tab" href="javascript:;" onclick="location.href = '<?php echo U('User/index');?>?level=0'">
                                    普通会员
                                </a>
                                </li>

                                <li <?php echo $level>0?'class="active"':'' ?>>
                                <a data-toggle="tab" href="javascript:;" onclick="location.href = '<?php echo U('User/index');?>?level=1'">
                                    管理员
                                </a>
                                </li>
                            </ul>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <form action="index.php" method="get" >                    
                                                <div class="row">
                                                    <div class='col-sm-2'>
                                                        <input class="form-control" placeholder='会员名称' type="text" name='uname' value='<?php echo ($uname); ?>'  />
                                                    </div>
                                                    <div class='col-sm-2'>
                                                        <input class="form-control" placeholder='UID' type="text" name='uid' value='<?php echo ($uid); ?>'  />
                                                    </div>
                                                    <div class='col-sm-2'>
                                                        <input class="form-control" placeholder='邮箱' type="text" name='email' value='<?php echo ($email); ?>'  />
                                                    </div>
                                                    <div class='col-sm-2'>                                        
