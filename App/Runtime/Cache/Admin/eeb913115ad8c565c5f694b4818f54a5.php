                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                            <div class="form-group" style="width:60%;margin:0 auto;height:600px;">
                                <ul>
                                <?php if(is_array($tables)): foreach($tables as $kk=>$v): ?><li><?php echo ($Kk); ?><input type="checkbox" name="tables[]" checked="checked" value="<?php echo ($v); ?>"><?php echo ($v); ?></li><?php endforeach; endif; ?>    
                                </ul>
                            </div>                                                       
