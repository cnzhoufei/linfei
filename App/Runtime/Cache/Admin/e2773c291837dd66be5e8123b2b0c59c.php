                        ...
                        <!-- PAGE CONTENT BEGINS -->                        
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <?php if($friendship){ ?>
                                    <?php if(is_array($friendship)): $i = 0; $__LIST__ = $friendship;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr class="pointer even" id="<?php echo ($data['id']); ?>" x='0' onclick="choose(this)">
                                            <td>
                                            <input type="text" value="<?php echo ($data['sorting']); ?>" style="width:50px;padding:0 5px;margin:0;border:none;" onchange="sorting('friendship',this,'<?php echo ($data['id']); ?>')" />
                                            </td>
                                            <td><?php echo ($data['id']); ?></td>
                                            <td><img src="<?php echo adminimg($data['id'],100,75,'friendship');?>"></td>
                                            <td class="td"><?php echo getsubstr($data['name'],0,60);?></td>
                                            <!-- <td><?php echo ($data['clicks']); ?></td> -->
                                           <td>
                                            <a  v="<?php echo ($data['blank']); ?>" href="javascript:;" onclick="status2('friendship', '<?php echo ($data[id]); ?>', 'blank', this)">
                                            ...
                                            <td>
                                            <a  v="<?php echo ($data['status']); ?>" href="javascript:;" onclick="status2('friendship', '<?php echo ($data[id]); ?>', 'status', this)">
                                            ...
                                            <td> 
                                                ...
                                                |
                                                <a id="" href="<?php echo U('Friendship/addfriendship');?>?id=<?php echo ($data['id']); ?>" title="">编辑</a>
                                                |
                                                <a id="" onclick="mydelete('<?php echo ($data['id']); ?>','friendship','img','<?php echo ($data['id']); ?>')" href="ajaxSrcipt:;" title="删除">删除</a> | 
                                            </td>
                                ...
                                <div class="row">
                                    <div class='col-sm-6'>
                                        <div class="row">
                                            ...
                                            <button class="col-sm-1 btn  btn-primary" type="button" value="全选" onclick="quanxuan();">
                                            全选
                                            </button>
                                            ...
                                            <button onclick="deletes('friendship','img')" class="col-sm-1 btn  btn-danger" type="button" value="删除">
                                            删除
                                            </button>
                                            <button onclick="states(1,'friendship','status')" class="col-sm-1 btn  btn-purple" type="button" value="上架">
                                            上架
                                            </button>
                                            <button onclick="states(0,'friendship','status')" class="col-sm-1 btn  btn-inverse" type="button" value="下架">
                                            下架
                                            </button>
                                             <button onclick="states(1,'friendship','blank')" class="col-sm-1 btn  btn-purple" type="button" value="新窗口打开">
                                            新窗口
                                            </button>
                                            <button onclick="states(0,'friendship','blank')" class="col-sm-1 btn  btn-inverse" type="button" value="本窗口打开">
                                            本窗口
                                            </button>
                                            <?php  ?>
