                    ...
                    <div class="col-xs-12">
                        ...
                        <input type="hidden" name="id" value="<?php echo ($product['id']); ?>" />
                         <input type="hidden" name="logo" value="<?php echo ($product['img']); ?>" />
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">产品标题<span style="color:#f00;">*</span></label>
                           ...
                           <style>#productimg img,#imgss img{width:100px;height: 100px;}</style>
                            ...
                            <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 产品类容 <span style="color:#f00;">*</span></label>
