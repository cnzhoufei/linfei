                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->                        
                            ...
                            <input type="hidden" name="id" value="<?php echo ($friendship['id']); ?>" />
                                                      
                                <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 友链名 <span style="color:#f00;">*</span></label>
                                        <div class="col-sm-9">
                                                <input type="text" name="name" value="<?php echo ($friendship['name']); ?>" class="col-sm-12" />
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="url" placeholder="例如：http://www.linfei.cc" value="<?php echo ($friendship['url']); ?>" class="col-sm-12" />
                                        </div>
                                </div>
                                <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 站长邮箱<span style="color:#f00;">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="text" name="email" placeholder="" value="<?php echo ($friendship['email']); ?>" class="col-sm-12" />
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="sorting" value="<?php echo intval($friendship['sorting']);?>" class="col-sm-12" />
                                        </div>
                                </div>
                                
                                <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 备注 <span style="color:#f00;">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="text" name="remarks" placeholder="例如：说明" value="<?php echo ($friendship['remarks']); ?>" class="col-sm-12" />
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                        <label>
                                            <input name="blank" class="ace ace-switch ace-switch-7" type="checkbox" <?php if(!$friendship['blank']){ }else{ ?>checked='checked'<?php } ?> value='1'>
                                            <span class="lbl"></span>
                                        </label>
                                        </div>
                                </div>
                                 <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                        <label>
                                            <input name="status" class="ace ace-switch ace-switch-7" type="checkbox" <?php if(!$friendship['status']){ }else{ ?>checked='checked'<?php } ?> value='1'>
                                            <span class="lbl"></span>
                                        </label>
                                        </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                <input  class="col-sm-12" type="button" value="上传图片" onClick="GetUploadify(1,'friendshipimg','imgs')" style="width:150px;" />   
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <span id="imgs"><img src="<?php echo ($friendship['img']); ?>"></span>
                            </div>
