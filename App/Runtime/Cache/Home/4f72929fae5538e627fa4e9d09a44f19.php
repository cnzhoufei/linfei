...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo ($style); ?>/css/goodlist.css">
	...
	<main class="main">
		...
		<!-- 轮播图 -->
		 <!--  <div id="wrapper">
					...
					<div class="fullwidthbanner">
						<ul>
							<li data-transition="3dcurtain-horizontal" data-slotamount="15" data-masterspeed="300">
								<img src="<?php echo ($style); ?>/images/slide3.jpg" style="width:100%;" alt="" />									
							</li>				
						</ul>
					</div>
			...
			<div class="lubT"></div>
<div>当前位置:<?php echo ($location); ?></div>
	<!-- 轮播图结束 -->
		<!-- 正文开始 -->
			<div class="goodList">
				<div class="goodT">
				...
				<div class="goodMain">
					...
					<?php if(is_array($product)): foreach($product as $key=>$v): ?><li>
							<a href="<?php echo ($v['url']); ?>"><img src="<?php echo homeimg($v['id'],250,250,'product');?>"></a>
							<div class="huodong">1212</div>
							<a href="<?php echo ($v['url']); ?>" class="qianggoua"><div class="qianggou"><span class="qianggou2">立即抢购</span></div></a>
							<div class="goodMu">
