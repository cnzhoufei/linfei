...
<head>
	...
	<meta charset="utf-8">
	<meta content="<?php echo ($product['keywords']); ?>" name="keywords">
	<meta content="<?php echo ($product['description']); ?>" name="description">
	<link rel="stylesheet" type="text/css" href="<?php echo ($style); ?>/css/index.css">
	<link rel="stylesheet" type="text/css" href="<?php echo ($style); ?>/css/news.css">
			...
			<div class="newsMain">
				...
				<div class="content">
					<div class="conternMain">
						<?php echo (htmlspecialchars_decode($product['text'])); ?>
				...
				<div class="newsFoot">
					<div class="newsL">
						<img src="<?php echo ($style); ?>/image/canvas.gif">
